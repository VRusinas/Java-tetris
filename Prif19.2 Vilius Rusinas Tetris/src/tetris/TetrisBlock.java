...
public class TetrisBlock 
{
    ...
    private Color[] availableColors = {Color.BLUE, Color.ORANGE, Color.RED, Color.LIGHT_GRAY};
    ...
    public void spwanAboveGame(int gridColumns)
    {
        Random r = new Random();
        currentRotation = r.nextInt(shapes.length); 
        shape = shapes[currentRotation]; 
        y = 0-getHeight(); 
        x = r.nextInt(gridColumns - getWidth()); 
